...
class Main:
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s\033[0;91m[\033[0;97m?\033[0;91m] \033[0;97mType a Name%s\033[0;91m(\033[0;97mEx: devi, Alina\033[0;91m):\033[0;97m "%(Y,G))
		nam = nam.replace(" ", "")
